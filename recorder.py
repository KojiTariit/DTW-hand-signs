...
def main():
    ...
    while cap.isOpened():
        ...
        if key == ord('r'):
            ...
            # --- Choice 1: Purpose ---
            print("\nSelect Purpose:")
            print("1. Train (Learning data)")
            print("2. Test (Verification data)")
            p_choice = input("Enter 1 or 2: ").strip()
            purpose = "Train_case" if p_choice == "1" else "Test_case"
            ...
            dir_path = f"c:/Users/USER/Desktop/DTW/templates/{purpose}/{category}"
